...
const bool getMeshAndFiberIntersection(float **&fiber, const uint32_t &nPoints, const uint32_t &nPtsLine, const uint32_t &N, const uint32_t &npbp, float **&index,
